...
"""Examples:
  ...
  $ python create_data.py -c config/reacher2d.json5 --watch render
  $ python create_data.py -c config/reacher2d.json5 --watch plt
  $ python create_data.py -c config/reacher2d.json5 --watch plt --save-anim
  $ python create_data.py -c config/point_mass.json5
""",
)
